...
```
```{r}
chrom_male2$`X` <- chrom_male2$`X`/2
```

```{r}
# Open a PDF device to save the plot
pdf("male_Ychrom_density_plot.pdf", width = 10, height = 6)  # Specify the file name and dimensions
...
```{r}
# Open a PDF device to save the plot
pdf("male_Xchrom_density_plot.pdf", width = 10, height = 6)  # Specify the file name and dimensions

# Create the plot
den <- density(chrom_male2$`X`)
plot(den, xlim = c(0, 2), xlab = "ChrX Copy Number Index")
...
```{r}
# Open a PDF device to save the plot
pdf("female_Ychrom_density_plot.pdf", width = 10, height = 6)  # Specify the file name and dimensions
...
```{r}
# Open a PDF device to save the plot
pdf("female_Xchrom_density_plot.pdf", width = 10, height = 6)  # Specify the file name and dimensions

# Create the plot
den <- density(chrom_Female$X)
plot(den, xlab = "ChrX Copy Number Index")
