---
title: "CNV Analysis CCLine for SCC-Lung"
...
Clinical_cell_lung <- Clinical_cell_lung[Clinical_cell_lung$V7 == "squamous_cell_carcinoma",]
```
...
```{r}
write_csv(LoY, "LoY_cell_info_lung.cvs")
```
